...
using AutoML_ModelBuilderML.Model.DataModels;

namespace AutoML_ModelBuilderML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\experiment\MLNETSeries\AutoML_ModelBuilder\AutoML_ModelBuilder\Data\Youtube-Spam2.csv";
        private static string MODEL_FILEPATH = @"../../../../AutoML_ModelBuilderML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.SdcaLogisticRegression(labelColumnName: "CLASS", featureColumnName: "Features");
